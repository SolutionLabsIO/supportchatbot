<script lang="ts">
  ...
  $: redirectTo = $page.url.searchParams.get('redirectTo') || '/conversations';
...
<div class="min-h-screen flex flex-col">
  <div class="flex-grow flex items-center justify-center bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
    <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
      <div class="text-center mb-8">
        <h1 class="text-3xl font-bold text-gray-800">Scholistico AI Chatbot</h1>
